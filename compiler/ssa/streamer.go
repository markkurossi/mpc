...
var circuitGenerators = map[Operand]NewCircuit{
	...
	Umod:  newUModulo,
	Index: newIndex,
	Ilt:   newBinary(circuits.NewIntLtComparator),
	Ult:   newBinary(circuits.NewUintLtComparator),
	Ile:   newBinary(circuits.NewIntLeComparator),
	Ule:   newBinary(circuits.NewUintLeComparator),
	Igt:   newBinary(circuits.NewIntGtComparator),
	Ugt:   newBinary(circuits.NewUintGtComparator),
	Ige:   newBinary(circuits.NewIntGeComparator),
	Uge:   newBinary(circuits.NewUintGeComparator),
